...
const findLastStudentId = () => __awaiter(void 0, void 0, void 0, function* () {
    const lastStudentId = yield user_model_1.User.findOne({ role: 'student' }, { id: 1, _id: 0 })
        .sort({
        createdAt: -1,
    })
        .lean();
    return (lastStudentId === null || lastStudentId === void 0 ? void 0 : lastStudentId.id) ? lastStudentId.id.substring(4) : undefined;
});
...
const generatedStudentId = (academicSemester) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    incrementdId = `${academicSemester === null || academicSemester === void 0 ? void 0 : academicSemester.year.substring(2)}${academicSemester === null || academicSemester === void 0 ? void 0 : academicSemester.code}${incrementdId}`;
    return incrementdId;
});
...
const findLastAdminId = () => __awaiter(void 0, void 0, void 0, function* () {
    const lastAdminId = yield user_model_1.User.findOne({ role: 'admin' }, { id: 1, _id: 0 })
        ...
        .lean();
    return (lastAdminId === null || lastAdminId === void 0 ? void 0 : lastAdminId.id) ? lastAdminId.id.substring(2) : undefined;
});
